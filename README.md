...
- download pupilprep from https://github.com/jwdegee/pupilprep/tree/main and install it into your environment by navigating to the directory and running `pip install -e .` in the terminal
